...
class _Game2048BoardState extends State<Game2048Board> {
  ...
  var _previousTileIds = <int>{};
  var _spawnedTileIds = <int>{};
  var _mergeSourceTiles = <Game2048Tile>[];
  var _mergeDestinations = <int, Game2048Position>{};
  var _hiddenMergeResultIds = <int>{};
    ...
    return GestureDetector(
      ...
      child: LayoutBuilder(
        builder: (context, constraints) {
          ...
          final padding = boardSize * 0.035;
          final gap = boardSize * 0.028;
